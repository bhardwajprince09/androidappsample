...
import static com.example.prince.talkshauk.R.drawable.bubble_a;

/**
 * Created by PRINCE on 3/15/2017.
 */
public class ChatArrayAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public View getView(int position,View ConvertView,ViewGroup parent){
        ...
        chatText.setBackgroundResource(messageobj.left ? bubble_a : R.drawable.bubble_b);
    ...
    public Bitmap decodeToBitmap(byte[] decodeByte){
        Object decodedByte;
        return BitmapFactory.decodeByteArray(decodeByte,0,decodedByte.length);
    }
}
